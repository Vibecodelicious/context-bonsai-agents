...
- **Polysemy vs. emphasis imbalance — diagnose carefully.** If a word is used in two senses, that is polysemy and the fix is renaming. If a word is used consistently but the surrounding emphasis makes a reader expect a different meaning, that is emphasis imbalance and the fix is reframing the section. Do not conflate them.
