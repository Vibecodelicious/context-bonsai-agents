...
| Hermes Agent | Verified | Standalone plugin — no Hermes fork; loads through Hermes's plugin system and replaces the built-in compressor as a context engine. Verified against hermes-agent `v2026.7.1` on 2026-07-07: full scenario matrix and a live Protocol A drive passed. Evidence: [`e2e-results-2026-07-07-live.md`](https://github.com/Vibecodelicious/hermes_context_bonsai/blob/main/docs/e2e-results-2026-07-07-live.md). | [Hermes Context Bonsai installation](https://github.com/Vibecodelicious/hermes_context_bonsai#installation) |
