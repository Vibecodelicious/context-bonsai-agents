...
| Claude Code via tweakcc | Verified | Native Claude Code `2.1.143` was exercised end to end with the tweakcc 4.0 apply harness and MCP server. Install wiring, prune/retrieve, marker persistence, resume handling, Protocol A, and pinned-target semantic patch evidence passed. | [tweakcc Context Bonsai installation](https://github.com/Vibecodelicious/tweakcc_context_bonsai#installation) |
