...
| `structural-unbound-harness` | The target harness has no bound slot table in Part 4 (§"How a routine cycle uses this spec", §4.6) | Nothing exists to invalidate — level-2 is absent | Owner-tier new-harness derivation |
